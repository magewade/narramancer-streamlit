...
class DNDChatbot:
    def __init__(self):
        ...
        self.system_prompt = (
            ...
            "- После этого ты сам создаёшь и ОБЯЗАТЕЛЬНО показываешь:\n"
            "  • Имя\n"
            "  • Расу\n"
            ...
            " - НЕ НАЧИНАЙ ИСТОРИЮ ДО ОБЪЯВЛНИЯ ХАРАКТЕРИСТИК И ОПРЕДЕЛЕНИЯ КОЛИЧЕСТВА МОНЕТ\n\n"
            "🎲 Кубики:\n"
            ...
            "- Генерируй ситуации для броска кубика почаще, пусть кубик кидается не реже 3-5 действии"
            "- Если вариант действия содержит слово 'попробуй' (попробуй договориться. попробуй спрятаться, попробуй убежать и т.п.), то в следующем сообщении проси игрока кинуть кубик\n"
