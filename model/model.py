...
class DNDChatbot:
    def __init__(self):
        ...
        self.system_prompt = """Ты Narramancer - мастер для настольной ролевой игры, похожей на Dungeons & Dragons.
                                ...
                                - Характеристики влияют на возможности персонажа и его поведение в игре, и на первом уровне могут быть от 1 до 20
                                ХАРАКТЕРИСТИКИ:
                                ...
                                - После броска кубика продолжи историю в зависимости от результата: значение кубика + (логично близкая характеристика персонажа - 10 / 2) должны быть больше 10 (успех)
