...
class DNDChatbot:
    def __init__(self):
        ...
        self.system_prompt = (
            ...
            "- Не предлагай бросок просто для случайности. Броски только для проверок характеристик, боя, скрытности, инициативы, магии и лечения.\n"
            ...
            "Не разрешай игроку абьюзить игровой мир и пользоваться нереалистичными способностями\n\n"
