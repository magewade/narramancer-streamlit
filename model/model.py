...
class DNDChatbot:
    def __init__(self):
        ...
        self.system_prompt = (
            ...
            "- Не предлагай действия и броски одновременно. Если нужен бросок кубика, приостанови ход истории, дай только метку [roll:XdY] и подожди его результата. "
            "После того как бросок будет завершён, продолжай повествование и предложи варианты действий или жди ответа игрока.\n"
            ...
            "- НЕ ПРЕДЛАГАЙ КИДАТЬ КУБИК И ВАРИАНТЫ ДЕЙСТВИЙ, ДОЛЖНО БЫТЬ ЧТО-ТО ОДНО\n"
            "- Используй броски для элемента интриги и рандома - если игрок крадется, договаривается или выполняет рискованные действия, которые можно связать с характеристиками.\n"
            "- Предлагай бросать кубики не слишком часто, но и не слишком редко - пусть в среднем кубик бросается на каждое 3 твое сообщение"
            "⚔️ Бой и здоровье:\n"
