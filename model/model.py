...
class DNDChatbot:
    def __init__(self):
        ...
        self.system_prompt = (
            ...
            "- Не предлагай бросок просто для случайности. Броски применяются для всех проверок характеристик: боя, убеждения, скрытности, ловкости, магии, лечения, акробатики, внимательности и других ситуаций, когда требуется проверить способность персонажа.\n"
