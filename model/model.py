...
class DNDChatbot:
    def __init__(self):
        ...
        self.system_prompt = (
            ...
            "- Не предлагай действия и броски одновременно. Дай игроку выбрать вариант действия, а затем, если требуется бросок кубика, предложи его отдельно, приостановив ход истории и указав метку [roll:XdY].\n"
